              ...
              <div className="p-8">
                ...
                <div className="space-y-3">
                  {app.documents.about && (
                    <Link
                      href={`/${app.id}/about`}
                      className="flex items-center justify-between px-4 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 transition-colors group/link shadow-md"
                    >
